...
export type TestLoaderCommandInput = z.infer<
  typeof TestLoaderCommandInputSchema
>;
...
export type TestLoaderCommandOutput = z.infer<
  typeof TestLoaderCommandOutputSchema
>;
