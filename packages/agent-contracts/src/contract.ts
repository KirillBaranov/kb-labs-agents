...
export const pluginContractsManifest = {
  ...
  artifacts: {
    "template.hello.greeting": {
      ...
      kind: "json",
      description:
        "Machine-readable greeting payload returned by the hello surfaces.",
  ...
  commands: {
    "plugin-template:hello": {
      ...
      description:
        "Produce a greeting message optionally targeting a provided name.",
      input: {
      ...
      examples: [
        ...
        "kb plugin-template hello --name Dev",
        "kb plugin-template hello --json",
      ],
    },
    "plugin-template:test-loader": {
      id: "plugin-template:test-loader",
      description:
        "Test UI loader/spinner functionality with various scenarios.",
      input: {
      ...
      examples: [
        ...
        "kb plugin-template test-loader --duration 1000",
        "kb plugin-template test-loader --fail",
      ],
    },
  },
  workflows: {
    "template.workflow.hello": {
      ...
      description:
        "Single-step workflow executing the hello command and emitting greeting artifacts.",
      produces: ["template.hello.greeting", "template.hello.log"],
      steps: [
        {
...
export type PluginRouteIds = typeof pluginContractsManifest.api extends {
  rest: { routes: infer R };
}
